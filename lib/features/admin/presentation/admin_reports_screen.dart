        ...
        child: Column(
          ...
          children: [
            ...
            const _TopProductRow(
                name: 'كوكاكولا شدة', qty: '142 شدة', amount: '1,349,000 ر.ي'),
            const _TopProductRow(
                name: 'بيبسي حبة', qty: '980 حبة', amount: '490,000 ر.ي'),
            const _TopProductRow(
                name: 'شيبس بطاطس', qty: '560 باكت', amount: '280,000 ر.ي'),
          ],
        ),
      ),
    );
...
class _TopProductRow extends StatelessWidget {
  ...
  const _TopProductRow(
      {required this.name, required this.qty, required this.amount});

                      ...
                      Container(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                              ...
                              fontSize: 15,
                              color:
                                  offer.active ? AppColors.error : Colors.grey),
                        ),
                      ),
                  ...
                  Row(
                    children: [
                      OutlinedButton.icon(
                        ...
                        label: const Text('إضافة منتجات للعرض',
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    _TypeChip('نسبة %', 'percent', selectedType,
                        () => setSS(() => selectedType = 'percent')),
                    const SizedBox(width: 10),
                    _TypeChip('مبلغ ثابت', 'fixed', selectedType,
  ...
  Widget build(BuildContext context) => GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
                color:
                    selected == value ? AppColors.primary : AppColors.border),

                ...
                children: [
                  _MenuSection('حسابي', [
                    _MenuItem(Icons.receipt_long_outlined, 'طلباتي',
                        AppColors.info, () => context.push(AppRoutes.orders)),
                    _MenuItem(
                  ...
                  _MenuSection('الدعم والمعلومات', [
                    _MenuItem(Icons.info_outline, 'من نحن', AppColors.primary,
                        () => context.push(AppRoutes.aboutUs)),
                    _MenuItem(Icons.phone_outlined, 'اتصل بنا', AppColors.info,
                        () => context.push(AppRoutes.contactUs)),
                    _MenuItem(Icons.help_outline_rounded, 'الأسئلة الشائعة',
                        AppColors.accent, () => context.push(AppRoutes.faq)),
                    _MenuItem(
                  ...
                  const SizedBox(height: 16),
                  const Text('البيرق هايبر ماركت v1.0.0',
                      style:

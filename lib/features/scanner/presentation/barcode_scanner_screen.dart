...
class _BarcodeScannerScreenState extends State<BarcodeScannerScreen>
    ...
    if (product != null) {
      ...
      await showModalBottomSheet(
        ...
        builder: (_) => ProductDetailsSheet(
          product: product,
          initialUnitIndex: provider.selectedUnitIndex,
        ),
      );
      ...
      AppMessage.error(
        context,
        provider.errorMessage ?? 'لم يتم العثور على منتج بهذا الباركود',
      );
  ...
  Widget build(BuildContext context) {
    ...
    final provider = context.watch<BarcodeScannerProvider>();
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (provider.lastScannedBarcode != null) ...[

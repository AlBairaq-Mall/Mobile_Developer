...
//       debugPrint('[DeliveryProvider] loadAvailableOrders: $error');
...
//       }
//     } catch (error, stackTrace) {
//       debugPrint('[DeliveryProvider] loadOrders: $error');
//       debugPrintStack(stackTrace: stackTrace);
...
//       }
//     } catch (error, stackTrace) {
//       debugPrint('[DeliveryProvider] refresh: $error');
//       debugPrintStack(stackTrace: stackTrace);
...
//       return null;
//     } catch (error, stackTrace) {
//       debugPrint('[DeliveryProvider] claimOrder: $error');
//       debugPrintStack(stackTrace: stackTrace);
...
//       }
//     } catch (error, stackTrace) {
//       debugPrint('[DeliveryProvider] loadOrder: $error');
//       debugPrintStack(stackTrace: stackTrace);
...
class DeliveryProvider extends ChangeNotifier {
  ...
  Future<void> loadAvailableOrders() async {
    ...
    try {
      ...
      debugPrint(
        '[DeliveryProvider] loadAvailableOrders: $error',
      );
  ...
  Future<void> loadOrders() async {
    ...
    try {
      ...
      debugPrint(
        '[DeliveryProvider] loadOrders: $error',
      );
  ...
  Future<void> refresh() async {
    ...
    try {
      ...
      debugPrint(
        '[DeliveryProvider] refresh: $error',
      );
  ...
  Future<String?> claimOrder(
    ...
    try {
      ...
      debugPrint(
        '[DeliveryProvider] claimOrder: $error',
      );
  ...
  Future<String?> updateOrderStatus(
    ...
    try {
      ...
      debugPrint(
        '[DeliveryProvider] updateOrderStatus: $error',
      );
  ...
  Future<void> loadOrder(
    ...
    try {
      ...
      debugPrint(
        '[DeliveryProvider] loadOrder: $error',
      );

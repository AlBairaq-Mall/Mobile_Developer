...
//     } catch (_) {
//       return ApiResponse<PaginatedResult<T>>.failure('خطأ في جلب البيانات');
//     }
//   }
...
//     } catch (_) {
//       return ApiResponse<T>.failure('ط­ط¯ط« ط®ط·ط£ ط؛ظٹط± ظ…طھظˆظ‚ط¹');
//     }
//   }
...
//     } catch (_) {
//       return ApiResponse<void>.failure('ط­ط¯ط« ط®ط·ط£ ط؛ظٹط± ظ…طھظˆظ‚ط¹');
//     }
//   }
